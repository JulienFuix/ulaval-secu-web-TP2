package julien.example.api.security.jwt;
...
public class JwtUtils {
    ...
    @Value("${julien.app.jwtExpirationMs}")
    private int jwtExpirationMs;

    @Value("${julien.app.jwtCookieName}")
    ...
    public String isTokenExpired(String authToken) {
